                ...
                <div className='flex justify-center items-center text-white'>
                  <form action="" method="">
                    ...
                    <div className='bg-slate-700  mb-6 rounded-lg px-3 py-2 flex justify-center items-center w-fit h-fit md:mx-5 ml-3 lg:mx-0'>
                      ...
                      <input className='form_textfield bg-slate-700 outline-none text-sm h-5 w-52 md:h-6 md:w-56 lg:h-8 lg:w-72  text-white md:text-lg font-semibold mr-3' type="text" name="text" required placeholder="Username" />
                      <i class="fa-solid fa-user cursor-pointer w-5"></i>
                    </div>
                  ...
                  <a href="">Forget Password ?</a>
                    ...
                    <div className='mb-6 mx-3 md:mx-5 lg:mx-0'>
                      <NavLink to='home'>
                        <button className='font-semibold text-white text-[12px] md:text-[14px] lg:text-[16px] transition-all duration-300 ease-linear
                                         ...
                                         shadow-yellow-500/50 hover:scale-105 active:scale-100'>Register</button>
                      </NavLink>
                    </div>
                    <  hr />
                    ...
                    <div className='flex justify-center items-center md:text-[14px] lg:text-normal text-[12px]  mt-10 mb-5'>
                      <div className='text-gray-500'>Already have an Account?<NavLink className='md:text-[14px] lg:text-normal font-light text-yellow-500 mb-6' to='login'> Login here</NavLink></div>
                    </div>
