  ...
  return (
    <>
      ...
      <div className=''>
          ...
          <div data-aos="fade-up"
            ...
            <div className='xl:w-[41rem] xl:h-[35rem] lg:w-[30rem] lg:h-[35rem] sm:w-[30rem] sm:h-[16rem] mx-10'>
              <div className='flex flex-col justify-center gap-3 md:gap-5 items-start w-full h-full'>
                ...
                <div className='flex justify-center items-center w-full'>
                  <CustomButton className="px-4 text-sm md:px-6 lg:px-8 border-green-700 text-green-700 hover:shadow-green-700 hover:bg-green-700 hover:text-white">EXPLORE</CustomButton>
                </div>
              </div>
            </div>
        ...
        <div className='w-full h-screen bg-yellow-200 section'>
