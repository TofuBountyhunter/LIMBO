      ...
      <div className='bg-gradient-to-r from-slate-900 to-slate-800 w-full h-screen'>
        ...
        <div className='flex justify-center items-center w-full h-screen'>
          <div className="lg:w-[800px] lg:min-h-[550px] md:w-[700px] md:min-h-[400px] w-[500px] min-h-[550px]   bg-slate-700 rounded-3xl m-5 shadow-lg shadow-black/50 overflow-hidden">
            <div className="md:bg-[url('./src/assets/20.jpg')] lg:w-full lg:h-[550px] md:w-full md:min-h-[400px] min-h-[550px] bg-no-repeat bg-fixed bg-center bg-cover object-cover ">
              <div className='lg:w-[400px] lg:h-[552px] md:w-[350px] md:min-h-[402px] min-h-[550px] bg-slate-900'>

                <div className='flex justify-center items-center text-white'>
                  <form action="" method="">

                    <div className='text-yellow-500 flex justify-center items-center mb-14 mt-6 lg:text-[35px] md:text-[28px] font-bold text-[28px]'>Login</div>
                    ...
                    <div className='flex justify-center items-center md:text-[14px] lg:text-normal text-[12px]  mt-10 mb-5'>
                      ...
                      <div className='text-gray-500'>Don't have an Account?<NavLink className='md:text-[14px] lg:text-normal font-light text-yellow-500 mb-6' to='register'> Register here</NavLink></div>
                    </div>
